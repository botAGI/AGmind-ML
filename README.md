...
| [**strizh-ru-retriever**](strizh-ru-retriever/) · [🤗](https://huggingface.co/AGmind/strizh-ru-retriever) · [GGUF](https://huggingface.co/AGmind/strizh-ru-retriever-GGUF) | RU-first no-prefix dense retriever: 4 layers, distilled by layer-pruning + BGE-M3 hard negatives. A speed/drop-in specialist — beats rubert-tiny2 on Russian, below USER2-small/bge-m3 on quality | `deepvk/RuModernBERT-small` | RU recall@10 0.75 (clean) / EN nDCG@10 0.34; 24M, fast on Strix Vulkan (slower on CPU) | ✅ on HF |
