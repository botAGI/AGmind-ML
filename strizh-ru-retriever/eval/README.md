...
| [`results-prod-pattern-strix-2026-07-27.txt`](results-prod-pattern-strix-2026-07-27.txt) | ранний сервисный профиль (без векторного поиска) + кривые по конкуренции (1–64) и батчам (1–128) | — |
